...
// JWT Circuit Configuration
// The circuit JSON artifact is available at: ./test-vectors/noir/stealthnote_jwt.json
// Circuit source code is in: ./noir-circuit/src/main.nr
